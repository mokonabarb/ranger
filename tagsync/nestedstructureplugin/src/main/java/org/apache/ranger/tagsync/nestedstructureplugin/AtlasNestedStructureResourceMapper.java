 ...
 * @author barbara_eckman@comcast.com
 **/
...
public class AtlasNestedStructureResourceMapper extends AtlasResourceMapper {
    ...
    public static final String SERVICE_NAME = "privacera_nestedstructure";

    public AtlasNestedStructureResourceMapper() {
        super("nestedstructure", SUPPORTED_ENTITY_TYPES);
    }
    ...
    public RangerServiceResource buildResource(final RangerAtlasEntity entity) throws Exception {
        ...
        RangerServiceResource ret = new RangerServiceResource(entityGuid, SERVICE_NAME, elements);
